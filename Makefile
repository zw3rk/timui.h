...
check: build test check-no-images check-conpty-smoke-tool check-conpty-win32-compile check-conpty-win32-smoke-compile check-hosted-visual-windows check-conpty-evidence-artifacts check-www ## Build + test gate
