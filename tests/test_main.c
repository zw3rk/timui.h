...
int main(void){
    ...
    test_fn tests[] = {
        ...
        test_open_failure_clears_output_handle,
        test_open_for_test_failure_does_not_close_injected_transport,
        ...
        test_input_csi_ss3_non_ascii_resync_no_loss,
        ...
        test_draw_overwrites_repair_wide_pairs,
        ...
        test_input_field_same_frame_edit_order,
        ...
        test_input_field_paste_split_utf8,
        ...
        test_clip_stack_overflow_preserves_pop_symmetry,
        ...
        test_table_renders,
        test_table_draws_keyboard_selection_same_frame,
        test_tree_renders,
        test_tree_draws_keyboard_selection_same_frame,
        test_tree_deep_safe,
        test_tree_controlled_no_write_without_change,
        test_table_ex_renders,
        test_table_ex_down_key,
        test_table_ex_hscroll,
        test_table_ex_wheel_only_when_hovered,
        test_tree_scroll_hides_collapsed,
        test_tree_scroll_wheel_only_when_hovered,
        test_tree_scroll_windows,
        test_cmd_palette_filter,
        test_cmd_palette_draws_keyboard_selection_same_frame,
        ...
        test_text_area_same_frame_edit_order,
        test_text_area_scroll_applies_before_draw,
        ...
        test_kitty_graphics_clip_horizontal_source_rect,
        test_kitty_graphics_respects_active_clip,
        test_kitty_graphics_placeholder,
        test_kitty_placement_overflow_placeholder,
